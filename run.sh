#!/bin/bash
#1.Here is a preprocess script.
python merge_train.py
#2.Here is a sample train script from training model using data of t1 without word2vec
...
#3.Here is a sample train script from training model using data of t2 without word2vec
...
#4.Here is a sample train script from training model using data of t1 with word2vec
...
#5.Here is a sample train script from training model using data of t2 with word2vec
...
#7.lightgbm Classifier model   # file: ./merge/result_lgb/t1/
python class_lgb_model.py

#8.xgboost Classifier model    # file: ./merge/result_xgb/t1/
python class_xgb_model.py

#9.catboost Classifier model   # file: ./merge/result_cat/t1/
python class_cat_model.py

#10.lightgbm Rank model         # file: ./merge/result_rank1/t1/    ./merge/result_rank2/t1/
