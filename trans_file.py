...
a_t1_valid = pd.read_csv("./merge/result_rank2/t1/valid_pred.tsv", sep='\t')
b_t1_valid = pd.read_csv("./merge/result_lgb/t1/valid_pred.tsv", sep='\t')
c_t1_valid = pd.read_csv("./merge/result_rank1/t1/valid_pred.tsv", sep='\t')
...
a_t2_valid = pd.read_csv("./merge/result_rank2/t2/valid_pred.tsv", sep='\t')
b_t2_valid = pd.read_csv("./merge/result_lgb/t2/valid_pred.tsv", sep='\t')
c_t2_valid = pd.read_csv("./merge/result_rank1/t2/valid_pred.tsv", sep='\t')
...
a_t1_test = pd.read_csv("./merge/result_lgb/t1/test_pred.tsv", sep='\t')
a_t1_test.columns = ['userId','itemId','score_a']
c_t1_test = pd.read_csv("./merge/result_rank1/t1/test_pred.tsv", sep='\t')
c_t1_test.columns = ['userId','itemId','score_c']
d_t1_test = pd.read_csv("./merge/result_cat/t1/test_pred.tsv", sep='\t')
d_t1_test.columns = ['userId','itemId','score_d']
e_t1_test = pd.read_csv("./merge/result_xgb/t1/test_pred.tsv", sep='\t')
e_t1_test.columns = ['userId','itemId','score_e']
f_t1_test = pd.read_csv("./merge/result_rank2/t1/test_pred.tsv", sep='\t')
...
a_t2_test = pd.read_csv("./merge/result_lgb/t2/test_pred.tsv", sep='\t')
a_t2_test.columns = ['userId','itemId','score_a']
c_t2_test = pd.read_csv("./merge/result_rank1/t2/test_pred.tsv", sep='\t')
c_t2_test.columns = ['userId','itemId','score_c']
d_t2_test = pd.read_csv("./merge/result_cat/t2/test_pred.tsv", sep='\t')
d_t2_test.columns = ['userId','itemId','score_d']
e_t2_test = pd.read_csv("./merge/result_xgb/t2/test_pred.tsv", sep='\t')
e_t2_test.columns = ['userId','itemId','score_e']
f_t2_test = pd.read_csv("./merge/result_rank2/t2/test_pred.tsv", sep='\t')
